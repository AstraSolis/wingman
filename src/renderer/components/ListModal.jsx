...
const trashIcon = <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="var(--danger)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M3 6h18"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/><line x1="10" y1="11" x2="10" y2="17"/><line x1="14" y1="11" x2="14" y2="17"/></svg>;

export default function ListModal({ title, items, type, onSelect, onDelete, onClose, t }) {
  return (
      ...
      <div className="modal-content">
        ...
        <div className="modal-list">
          {!items?.length ? (
            ...
            <div key={i} className="list-item" onClick={() => onSelect(item)}>
              ...
              {type === 'favorites' && (
                <div className="list-item-actions">
                  <button className="icon-btn" onClick={e => { e.stopPropagation(); onDelete(item, i); }}>{trashIcon}</button>
                </div>
              )}
            </div>
          ))}
